 ...
 */
final class Version20220706072905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agents (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, firstname VARCHAR(30) NOT NULL, birthday_date DATE NOT NULL, code INT NOT NULL, nationality VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE contacts (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, firstname VARCHAR(30) NOT NULL, birthday_date DATE NOT NULL, namecode VARCHAR(30) NOT NULL, nationality VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE targets (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, firstname VARCHAR(30) NOT NULL, birthday_date DATE NOT NULL, namecode VARCHAR(30) NOT NULL, nationality VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(30) NOT NULL, firstname VARCHAR(30) NOT NULL, created_at DATE NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
